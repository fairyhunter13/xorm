...
var (
	...
	db2Quoter        = schemas.Quoter{'"', '"', schemas.AlwaysReserve}
)
...
func (db *db2) Init(d *core.DB, uri *URI) error {
	db.quoter = db2Quoter
...
func (db *db2) IsColumnExist(ctx context.Context, tableName, colName string) (bool, error) {
...
func (db *db2) GetColumns(ctx context.Context, tableName string) ([]string, map[string]*schemas.Column, error) {
	args := []interface{}{tableName}
...
func (db *db2) GetTables(ctx context.Context) ([]*schemas.Table, error) {
	args := []interface{}{}
...
func (db *db2) GetIndexes(ctx context.Context, tableName string) (map[string]*schemas.Index, error) {
	args := []interface{}{tableName}
